 ...
 */
public class BackupStaggeredGridView extends ViewGroup {
    ...
    public BackupStaggeredGridView(Context context) {
        this(context, null);
    }

    public BackupStaggeredGridView(Context context, AttributeSet attrs) {
    ...
    {
    	mScroller.startScroll(0, getChildCount()*mFirstPosition, 0,getChildCount()*mFirstPosition);
    }*/
...
//                final int colEnd = Math.min(mColCount, nextCol + lp.span);
    ...
    public interface OnItemClickListener {
         ...
         *
         * @param staggeredGridView2   The AdapterView where the click happened.
         * @param view     The view within the AdapterView that was clicked (this
         *                 will be a view provided by the adapter)
         * @param position The position of the view in the adapter.
         * @param id       The row id of the item that was clicked.
         */
        void onItemClick(BackupStaggeredGridView staggeredGridView2, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         *
         * @param staggeredGridView2   The AbsListView where the click happened
         * @param view     The view within the AbsListView that was clicked
         * @param position The position of the view in the list
         * @param id       The row id of the item that was clicked
         * @return true if the callback consumed the long click, false otherwise
         */
        boolean onItemLongClick(BackupStaggeredGridView staggeredGridView2, View view, int position, long id);
    }
    ...
    public void setHeaderView(View v) {
        ...
        BackupStaggeredGridView.LayoutParams lp = new BackupStaggeredGridView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT);
